      ...
      <div className='space-y-5'>
        <div className='flex flex-wrap gap-5 items-center'>
          ...
          p-4 w-56 rounded-md'>
            ...
            <div>
            <p className='text-2x] font-medium text-gray-600'>{dashboardData.enrolledStudentsData.length}</p>
          ...
          p-4 w-56 rounded-md'>
            ...
            <div>
            <p className='text-2x] font-medium text-gray-600'>{dashboardData.totalcourses}</p>
          ...
          p-4 w-56 rounded-md'>
            ...
            <div>
            <p className='text-2x] font-medium text-gray-600'>{currency}{dashboardData.totalEarnings}</p>
        ...
        rounded-md bg-white border border-gray-500/20">
          ...
          {dashboardData.enrolledStudentsData.map ((item, index) => (
            <tr key={index} className="border-b border-gray-500/20" >
              <td className="px-4 pу-3 text-center hidden sm:table-cell">
              {index + 1}
              </td>
              ...
              <td className="px-4 py-з truncate">{item.courseTitle}</td>
              </tr>
          ))}
          </tbody>
          </table>
